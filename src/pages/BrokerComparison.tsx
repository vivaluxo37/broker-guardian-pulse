...
// Using the exact same 88 brokers from broker reviews page
const reviewBrokers = [
  { id: "interactive-brokers", name: "Interactive Brokers", logo: "/lovable-uploads/a278588e-21c7-4534-bd33-a5e69e619191.png", rating: 4.9 },
  { id: "ic-markets", name: "IC Markets", logo: "/lovable-uploads/64b914e9-41e8-49b4-9132-f149648ce8ff.png", rating: 4.4 },
  { id: "xtb", name: "XTB", logo: "/lovable-uploads/0eabf75e-7984-481a-85ea-46dfc5362774.png", rating: 4.7 },
  ...
  // ... continuing with all 88 brokers
];

const allBrokers: Broker[] = reviewBrokers.map((broker, index) => ({
  id: (index + 1).toString(),
  name: broker.name,
  logo: broker.logo,
  ...
  goldSpread: 0.5,
  commission: "Variable",
  swapRates: { long: "0", short: "0" },
  platforms: ["Platform"],
  platformFeatures: {},
  account_types: ["Standard"],
  accountDetails: {},
  instruments: { forex: 50, stocks: 100, indices: 10, commodities: 5, crypto: 10, bonds: 0, etfs: 0 },
  executionModel: "Market Maker",
  averageExecutionSpeed: "< 1 second",
  slippage: "Low",
  requotes: "Rare",
  depositMethods: ["Various"],
  withdrawalMethods: ["Various"],
  depositFees: "Variable",
  withdrawalFees: "Variable",
  withdrawal_time: "1-5 days",
  baseCurrencies: ["USD", "EUR"],
  customer_support: "24/5",
  supportLanguages: 10,
  education: true,
  educationFeatures: ["Basic tutorials", "Market analysis"],
  demo_account: true,
  ...
  apiAccess: false,
  vpsOffered: false,
  researchTools: ["Basic tools", "Market data"],
  founded: 2010,
  mobilePlatform: true,
  webPlatform: true,
  socialTrading: false,
  ...
  pros: ["Professional platform", "Good support"],
  cons: ["Fees may apply", "Minimum deposit required"]
}));
